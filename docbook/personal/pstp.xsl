...
<xsl:stylesheet
	...
	<xsl:template match="xhtml:link[@rel = 'stylesheet']" mode="ctxsl:all-xhtml2xhtml">
		<xsl:choose>
			...
			<xsl:otherwise>
				<link type="text/css" title="Default" rel="stylesheet" href="https://crustytoothpaste.ath.cx/css/docbook-xhtml/default.css"/>
				<link type="text/css" title="Simple" rel="alternate stylesheet" href="https://crustytoothpaste.ath.cx/css/docbook-xhtml/simple.css"/>
				<link type="text/css" title="Complexspiral" rel="alternate stylesheet" href="https://crustytoothpaste.ath.cx/css/docbook-xhtml/complexspiral.css"/>
				<link type="text/css" title="Water" rel="alternate stylesheet" href="https://crustytoothpaste.ath.cx/css/docbook-xhtml/water.css"/>
				<!--
				...
				-->
				<link type="text/css" title="New (testing only)" rel="alternate stylesheet" href="https://crustytoothpaste.ath.cx/css/docbook-xhtml/new.css"/>
			</xsl:otherwise>
		</xsl:choose>
		<!--
